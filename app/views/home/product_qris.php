...
<div class="pt-32 pb-24 bg-white min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <!-- Badge -->
        <div class="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-semibold bg-blue-50 text-blue-600 mb-6">
            <i class="fa-solid fa-qrcode mr-2"></i> Produk Pembayaran
        </div>
        
        <h1 class="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">
            Pembayaran Instan dengan <span class="text-blue-600">QRIS</span>
        </h1>
        
        <p class="text-xl text-gray-500 mb-12 max-w-2xl mx-auto leading-relaxed">
            Terima pembayaran dari seluruh aplikasi E-Wallet dan Mobile Banking di Indonesia dengan satu kode QR.
        </p>
        ...
        <div class="p-12 bg-gray-50 rounded-3xl border border-gray-100 shadow-sm flex flex-col items-center justify-center min-h-[300px]">
            ...
            <p class="text-gray-500">Rincian teknis dan keunggulan QRIS KathaPayment sedang dipersiapkan.</p>
            <a href="<?= base_url('') ?>" class="mt-8 text-blue-600 font-semibold hover:text-blue-700">
